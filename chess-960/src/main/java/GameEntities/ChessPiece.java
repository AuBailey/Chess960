...
public abstract class ChessPiece implements ChessPieceInterface {
	...
	/**
	 * Sets the private members of the ChessPiece. Such as it's owner the lcoation
	 * and the game it belongs to.
	 * 
	 * @param owner
	 *            Owner string.
	 * @param initialLocation
	 *            Location to set knight in.
	 * @param game
	 *            Game that the knight belongs too.
	 */
	 ...
	 * 
	 * @param rowOne
	 *            The row direction to check in
	 * @param colOne
	 *            The col direction to check in
	 */
	 ...
	 * 
	 * @param newLocation
	 *            The new location of the knight.
	 */
